...
bool VisualPoint::getCloseViewObs(const Vector3d &framepos, Feature *&ftr,
  ...
  // if(pixel_dist > 200)
  // {
  //   LOG_ERROR_F("The pixel dist exceeds 200.");
  //   return false;
  // }
...
void VisualPoint::findMinScoreFeature(const Vector3d &framepos,
                                      Feature *&ftr) const {
  auto min_it = obs_.begin();
